<nav id="sidenav" class="z-index-max nav-sidenav bg-eerie-black overflow-auto position-fixed top-0 h-100">
  ...
  <div class="sub-nav border-top border-alpha2-white p-4 text-white">
    ...
    <form action="/search.stml" class="mt-4">
      <div class="input-group mb-3">
        <label class="sr-only" for="search">Search</label>
        <input class="form-control" type="text" id="search" name="q" required aria-label="Search" placeholder="Search">
        <div class="input-group-append">
          <button class="btn btn-primary border-0" type="submit"><i class="fas fa-lg fa-search"></i></button>
        </div>
      </div>
    </form>
  </div>
