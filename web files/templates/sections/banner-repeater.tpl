  ...
  <div class="panel panel-default">
    ...
    <div id="collapseLinks" class="panel-collapse collapse in">
      <div class="panel-body">
        <div class="row">
          <div class="col-md-6">
            <h2><label class="control-label" for="banner_link">Link</label></h2>
            <input type="text" class="form-control" name="banner_link" id="banner_link">
          </div>

          <div class="col-md-6">
            <h2><label class="control-label" for="url_new_window">Open in New Window</label></h2>
            <input type="checkbox" name="url_new_window" id="url_new_window" value="1">
          </div>
          </div>
          <div class="row">
          <div class="col-md-6" id="listingImage">
                <h2><label class="control-label" for="banner_image">Banner Image</label></h2>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseBannerDisplay" class="panel-collapse collapse in">
      <div class="panel-body">
        <div class="row">
        <div class="col-md-3">
            <h2><label class="control-label" for="banner_size">Ad Size</label></h2>
          ...
          <div class="col-md-3">
            <h2><label class="control-label" for="banner_all_pages">Show on All Pages</label></h2>
