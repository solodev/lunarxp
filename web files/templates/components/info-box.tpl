<div class="border p-4">
      ...
      <div class="mt-4">
        ...
        <p>Fill out the form to the left. Someone from the Solodev team will be in touch.</p>
       
      <div class="mt-4">  
        <p><strong>Need help with existing subscriptions?</strong></p>
        <p>Submit a <a href="/features/support.stml" target="_blank" class="text-blue">support request</a> or check out the <a href="https://solodev.zendesk.com/agent" target="_blank" class="text-blue">Enterprise documentation</a></p>
        </div>
      </div>