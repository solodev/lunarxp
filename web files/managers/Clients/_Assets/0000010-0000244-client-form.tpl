...
<h4 class="panel-title"><a aria-expanded="true" data-toggle="collapse" href="#collapseStatus">Post Status<span class="toggle" aria-hidden="true"></span></a></h4>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a aria-expanded="true" data-toggle="collapse" href="#collapseInfo">Client Info <span class="toggle" aria-hidden="true"></span></a></h4>
</div>
...
<input class="file_upload" id="featured_client_image" name="featured_client_image" required="" type="file" /></div>

<div class="col-md-4">
<h2><label class="label-control" for="featured_detail_image">Detail Image</label></h2>
<input class="file_upload" id="featured_detail_image" name="featured_detail_image" required="" type="file" /></div>

<div class="col-md-4">
<h2><label class="label-control" for="client_url">Client Website URL</label></h2>
<input class="form-control" id="client_url" name="client_url" required="" type="text" /></div>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a aria-expanded="true" data-toggle="collapse" href="#collapseContent">Post Content<span class="toggle" aria-hidden="true"></span></a></h4>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a data-toggle="collapse" href="#collapseAdvanced">Advanced <span class="toggle" aria-hidden="true"></span></a></h4>
</div>
