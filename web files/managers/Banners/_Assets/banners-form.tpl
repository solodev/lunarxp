      ...
      <div class="card-body">
        <div class="row align-items-center">
          <div class="col-md-6 form-group">
            <h3 class="card-title"><label class="label-control" for="banner_link">Link</label></h3>
          ...
          <div class="col-md-6">
            <div class="checkbox-custom checkbox-default checkbox-inline">
              ...
              <label class="label-control mb-0 ml-3" for="url_new_window">Open in New Window</label>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6" id="listingImage">
            <h3 class="card-title"><label class="label-control" for="banner_image">Banner Image</label></h3>
  ...
  <section class="card" class="mt-2">
    ...
    <div id="collapseBannerDisplay" class="collapse show" aria-labelledby="headingBannerDisplay" data-parent="#accordionBannerDisplay">
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
            <h3 class="card-title"><label class="label-control" for="banner_size">Ad Size</label></h3>
          ...
          <div class="col-md-3">
            <h3 class="card-title"><label class="label-control" for="banner_all_pages">Show on All Pages</label></h3>
