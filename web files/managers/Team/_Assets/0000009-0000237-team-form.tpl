...
<select class="form-control" name="post_status" type="text"><option value="Draft">Draft</option><option value="Published">Published</option> </select></div>

<div class="col-md-3">
<h2><label class="label-control" for="post_author">Post Author</label></h2>
<select class="form-control" name="post_author" type="text"><option value="None">None</option><option value="AUTHOR_NAME">AUTHOR_NAME</option> </select></div>
</div>
</div>
</div>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a aria-expanded="true" data-toggle="collapse" href="#collapseImages">Image Uploads <span class="toggle" aria-hidden="true"></span></a></h4>
</div>
...
<p class="subText">(Required) The image that appears in the post and normal blogroll feed. Dimensions: 951px by 561px.</p>
<input class="file_upload" id="team_member_image" name="team_member_image" required="" type="file" /></div>

<div class="col-md-6">
<h2><label class="label-control" for="team_member_pos">Team Member Position</label></h2>
<input class="form-control" id="team_member_pos" name="team_member_pos" required="" type="text" /></div>
</div>
</div>
</div>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a aria-expanded="true" data-toggle="collapse" href="#collapseContact">Team Contact <span class="toggle" aria-hidden="true"></span></a></h4>
</div>
...
<input class="form-control" id="team_member_email" name="team_member_email" required="" type="text" /></div>

<div class="col-md-3">
<h2><label class="label-control" for="team_member_phone">Team Member Phone</label></h2>
<input class="form-control" id="team_member_phone" name="team_member_phone" required="" type="text" /></div>

<div class="col-md-3">
<h2><label class="label-control" for="team_member_location">Team Member Location</label></h2>
<input class="form-control" id="team_member_location" name="team_member_location" required="" type="text" /></div>

<div class="col-md-3">
<h2><label class="label-control" for="team_member_hours">Team Member Hours</label></h2>
<input class="form-control" id="team_member_hours" name="team_member_hours" required="" type="text" /></div>
</div>
</div>
</div>
</div>
...
<input class="form-control" id="heading_title" name="heading_title" type="text" /></div>
</div>
...
<textarea class="form-control" id="post_intro" name="post_intro" required=""></textarea></div>
</div>
...
<textarea class="wysiwyg" id="post_content" name="post_content" required=""></textarea></div>
</div>
</div>
</div>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a data-toggle="collapse" href="#collapseMeta">META Data <span class="toggle"
...
<input class="form-control" id="meta_title" name="meta_title" type="text" /></div>
</div>
...
<textarea class="form-control" id="meta_description" name="meta_description"></textarea></div>
</div>
...
<textarea class="form-control" id="meta_keywords" name="meta_keywords"></textarea></div>
</div>
</div>
</div>
</div>
...
<textarea class="form-control" id="post_javascript" name="post_javascript"></textarea></div>
</div>
</div>
</div>
</div>
...
<div class="panel panel-default">
<div class="panel-heading">
<h4 class="panel-title"><a data-toggle="collapse" href="#collapseURL">Post URL <span class="toggle"
                        aria-hidden="true"></span></a></h4>
</div>
...
<a href="https://www.100k-theme.com<?= $calendar_entry->path ?>" target="_blank">https://www.100k-theme.com <?= $calendar_entry->path ?></a></div>
</div>
</div>
</div>
</div>
