...
<div class="row">
	<div class="col-md-12 form-group">
		...
		<textarea class="form-control wysiwyg-basic" id="career_intro" name="career_intro"></textarea>
	</div>
</div>
<div class="row">
	<div class="col-md-5 form-group">
		<label class="control-label" for="career_icon">Icon</label>
		<p class="card-subtitle">(Required) Enter the <a href="https://fontawesome.com/" target="_blank" class="text-color1">Font Awesome 5</a> class(es) necessary to display the icon. (i.e: fas fa-heart )</p>
		<input class="form-control" id="career_icon" name="career_icon" type="text">
	</div>
</div>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<p class="card-subtitle mt-0">(Required) The position/title of the member.</p>
					...
					<div class="col-md-6 form-group">
						...
						<p class="card-subtitle mt-0">(Required) The email address of the member.</p>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<p class="card-subtitle mt-0">(Required) The phone number of the member.</p>
					...
					<div class="col-md-6 form-group">
						...
						<p class="card-subtitle mt-0">(Required) The availability hours of the member.</p>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<p class="card-subtitle mt-0">(Required) The location of the member.</p>
