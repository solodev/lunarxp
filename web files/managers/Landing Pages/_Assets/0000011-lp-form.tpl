<div class="row m-0">
	<div class="col-md-7 form-group p-0">
		<label class="control-label" for="heading_title">Heading Overwrite <small>(This will become the main H1 heading)</small></label>
		<input type="text" class="form-control" name="heading_title" id="heading_title">
	</div>
	<div class="col-md-5 form-group">
		<h3 class="card-title"><label class="control-label" for="main_image">Featured Image <small>(The main image below the title)</small></label></h3>
		<input class="form-control" id="main_image" name="main_image" type="file" />
	</div>
</div>
<div class="row m-0">
	<div class="col-md-12 p-0">
		<h3 class="card-title"><label class="control-label" for="landing_page_content">Content</label></h3>
