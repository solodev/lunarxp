    ...
    <div class="panel panel-default">
        ...
        <div id="collapseContent" class="panel-collapse collapse in">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="main_image">Main Image</label></h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2><label class="control-label" for="landing_page_content">Landing Page Content</label></h2>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseMiddleContent" class="panel-collapse collapse">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-8">
                        <h2><label class="control-label" for="mid_title">Middle Content Title</label></h2>
                        <p class="subText">Main title for the Middle Section</p>
                        <input class="form-control" type="text" id="mid_title" name="mid_title">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="mid_content_btn">Middle Content Button Text</label></h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2><label class="control-label" for="mid_content_supporting">Middle Supporting Text</label></h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h2><label class="control-label" for="linkTypeSelect">Link Type</label></h2>
                    ...
                    <div class="col-md-6" id="linkTypeInternal">
                        <h2><label class="control-label" for="internal_page">Internal Page URL</label></h2>
                    ...
                    <div class="col-md-6" id="linkTypeExternal" style="display:none;">
                        <h2><label class="control-label" for="external_page">Resource URL</label></h2>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_1_heading">Box 1 Heading</label></h2>
                        <input class="form-control" id="box_1_heading" name="box_1_heading" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_1_icon">Box 1 Icon</label></h2>
                    ...
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_1_text">Box 1 Text</label></h2>
                        <p class="subText">(Required) Add external URL.</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_2_heading">Box 2 Heading</label></h2>
                        <input class="form-control" id="box_2_heading" name="box_2_heading" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_2_icon">Box 2 Icon</label></h2>
                        <p class="subText">Enter the <a target="_blank" href="https://fontawesome.com/icons">Font Awesome 5</a> classes your icon uses. Ex: fab fa-facebook-f</p>
                        <input class="form-control" id="box_2_icon" name="box_2_icon" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_2_text">Box 2 Text</label></h2>
                        <p class="subText">(Required) Add external URL.</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_3_heading">Box 3 Heading</label></h2>
                        <input class="form-control" id="box_3_heading" name="box_3_heading" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_3_icon">Box 3 Icon</label></h2>
                        <p class="subText">Enter the <a target="_blank" href="https://fontawesome.com/icons">Font Awesome 5</a> classes your icon uses. Ex: fab fa-facebook-f</p>
                        <input class="form-control" id="box_3_icon" name="box_3_icon" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_3_text">Box 3 Text</label></h2>
                        <p class="subText">(Required) Add external URL.</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_4_heading">Box 4 Heading</label></h2>
                        <input class="form-control" id="box_4_heading" name="box_4_heading" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_4_icon">Box 4 Icon</label></h2>
                        <p class="subText">Enter the <a target="_blank" href="https://fontawesome.com/icons">Font Awesome 5</a> classes your icon uses. Ex: fab fa-facebook-f</p>
                        <input class="form-control" id="box_4_icon" name="box_4_icon" type="text">
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="box_4_text">Box 4 Text</label></h2>
                        <p class="subText">(Required) Add external URL.</p>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseBottom" class="panel-collapse collapse">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4">
                        <h2><label class="control-label" for="bottom_tile_title">Bottom Tile Title</label></h2>
                        <input class="form-control" id="bottom_tile_title" name="bottom_tile_title" type="text" />
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="bottom_tile_text">Bottom Tile Text</label></h2>
                        <input class="form-control" id="bottom_tile_text" name="bottom_tile_text" type="text" />
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="bottom_tile_image">Bottom Tile Image</label></h2>
                        <input class="form-control" id="bottom_tile_image" name="bottom_tile_image" type="file" />
                    </div>
                    <div class="col-md-6">
                        <h2><label class="control-label" for="bottom_cta_link">Bottom Tile Call to Action Link</label></h2>
                        <input class="form-control" id="bottom_cta_link" name="bottom_cta_link" type="text" />
                    </div>
                    <div class="col-md-6">
                        <h2><label class="control-label" for="bottom_cta_text">Bottom Tile Call to Action Text</label></h2>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <h2><label class="control-label" for="formtitle">Lead Form Title</label></h2>
                        <p class="subText">(Appears Above Form)</p>
                        <input class="form-control" id="formtitle" name="formtitle" type="text" />
                    </div>
                    <div class="col-md-4">
                        <h2><label class="control-label" for="formcall">Lead Form Action</label></h2>
                    ...
                    <div class="col-md-4">
                        <h2><label class="control-label" for="formtext">Lead Form Call to Action</label></h2>
