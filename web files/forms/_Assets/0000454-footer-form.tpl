<div id="bottom-signup-form">
	...
	<div class="row mt-5 d-md-flex align-items-end">
		<div class="form-group col-lg-3 px-md-2 pt-md-2 mt-lg-0 pb-5 position-relative">
			...
			<div class="help-block with-errors position-absolute bottom-0 left-0 pl-2"></div>
		</div>
		<div class="form-group col-lg-3 px-md-2 pt-md-2 mt-lg-0 pb-5 position-relative">
		...
		<div class="form-group col-lg-3 px-md-2 pt-md-2 mt-lg-0 pb-5 text-center text-lg-left mt-4">
