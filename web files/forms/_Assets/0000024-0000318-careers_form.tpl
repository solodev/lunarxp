<div class="primary-top-border bg-tertiary mt-sm-4 mt-md-0 p-3 p-xl-4">
    <h3 class="text-uppercase mb-5 text-center"><strong>Apply Now!</strong></h3>
    ...
    <div class="form-group mt-3">
      <label class="font-weight-bold" for="address">Address <span class="text-scarlet">*</span></label> 
    ...
    <div class="form-group mt-3">
      <label class="font-weight-bold" for="position">Position applying for <span class="text-scarlet">*</span></label> 
    ...
    <div class="form-group mt-3">
      <label class="font-weight-bold" for="upload_resume">Upload Resume <span class="text-scarlet">*</span></label> 
      <input type="file" name="upload_resume" id="upload_resume" class="form-control-file rounded-0 w-100 mt-1 bg-transparent border-0 p-0">
    </div>
    <div class="text-center">
      <input type="submit" class="btn btn-primary btn-lg mt-3 h5" value="Send Application">
    </div>
  </div>